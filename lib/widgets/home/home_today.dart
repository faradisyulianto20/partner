...
import 'package:hackathon/widgets/home/recomendation_dialog.dart';

class HomeToday extends StatelessWidget {
  /// Null berarti belum ada deteksi emosi hari ini (unchecked).
  /// Jika diisi, berarti sudah terdeteksi (checked).
  final String? emotion;

  /// Kutipan/pesan yang ditampilkan saat sudah terdeteksi.
  final String? message;

  /// Gunakan 'happy' atau 'sad'. Default: 'happy'.
  final String iconType;

  /// Daftar rekomendasi: list of {'title': '...', 'description': '...'}
  ...
  void _showRecommendationDialog(BuildContext context) {
    showDialog(
      ...
      builder: (context) => RecomendationDialog(
        // Pass recommendations to the dialog if needed
       ),
    );
  }
          ...
          Container(
            ...
            child: Center(
              child: SvgPicture.asset(
                iconType == 'sad'
                    ? 'assets/img/sad_white.svg'
                    : 'assets/img/happy_white.svg',
                width: 42,
                height: 42,
              ),
            ),
