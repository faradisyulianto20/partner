...
export class JournalService {
  ...
  private async analyzeMood(title: string, content: string) {
    ...
    const moodCategory = this.normalizeMoodCategory(
      parsed.moodCategory ?? parsed.category ?? parsed.mood,
    );
  ...
  private normalizeMoodCategory(
    value: unknown,
  ): JournalMoodResult['moodCategory'] {
